// bu kısmı kopyala yapıştır yapıldı
...
// API
@RestController
@CrossOrigin(origins = FrontEnt.REACT_URL)//farklı portlarla haberleşmeyi sağlar
public class CustomErrorHandleWebRequest implements ErrorController {
    ...
    */
 // zorunlu olarak parametreli constaktır oluşturmak zorunda kalıyoruz
    ...
    public ApiResult springMyHandleErrorMethod(WebRequest webRequest){
        ...
        // Spring'ten gelen verileri almak bulması için
